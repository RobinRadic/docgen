...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./utilities", "./storage"], factory);
    }
    ...
    var PreferenceSelectControl = (function (_super) {
        ...
        function PreferenceSelectControl(pref) {
            var _this = _super.call(this, pref) || this;
            _this.options = {};
            _this.$el = utilities_1.cre('select').addClass('form-control').attr('id', pref.id);
            pref.$controlWrapper.append(_this.$el);
            return _this;
        }
