...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "jquery", "async", "./BaseApp", "./modules/utilities", "./modules/configuration", "./modules/storage", "svg", "./modules/debug"], factory);
    }
    ...
    var Layout = (function (_super) {
        ...
        function Layout() {
            ...
            _this.openCloseInProgress = false;
            _this.closing = false;
            _this.logo = {};
            return _this;
        }
